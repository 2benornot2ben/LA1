...
//				System.out.println("1:  Search from music store.");
//				System.out.println("2:  Search from you library.");
...
//				System.out.println("7:  Get a list from your library.");
//				System.out.println("8:  Add a song to your playlist.");
//				System.out.println("9:  Remove a song from your playlist");
//				System.out.println("10: Mark a song as favorite.");
//				System.out.println("11: Exit and terminate a program.");
//				System.out.println("");
			...
			if (holdInputLower.split(" ")[0].equals("search") && holdInputLower.split(" ").length > 1 &&
				...
				if(songs.size() == 0) {
			        ...
			        if(isNumeric(number)) {
			        	...
			        	if(num > 0 && num < 6) {
							...
							if(exist) {
								if(rated) {
									System.out.println(title + " by " + artist + " has been rated.");
								} else {
									System.out.println(title + " by " + artist + " not found.");
								}
							} else {
								System.out.println(title + " by " + artist + " is not in the library");
							}
			        	}
			        	else {
				...
				if(songs.size() == 0) {
					...
					if(exist) {
						if(marked) {
							System.out.println(title + " by " + artist + " has been marked as favorite");
						} else {
							System.out.println(title + " by " + artist + " is already marked as favorite");
						}
					} else {
						System.out.println(title + " by " + artist + " is not in the library");
					}
